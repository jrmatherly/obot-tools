...
func main() {
	...
	enableCircuitBreaker := os.Getenv("OBOT_DEEPSEEK_MODEL_PROVIDER_CIRCUIT_BREAKER_ENABLED") == "true"
	var circuitBreakerConfig *proxy.CircuitBreakerConfig
	if enableCircuitBreaker {
		circuitBreakerConfig = proxy.LoadCircuitBreakerConfigFromEnv("DeepSeek", "OBOT_DEEPSEEK_MODEL_PROVIDER_")
	}
